...
import (
	...
	clusterutil "github.com/harrycodawang/rocketmq-operator/pkg/api/cluster"
	v1alpha1 "github.com/harrycodawang/rocketmq-operator/pkg/apis/rocketmq/v1alpha1"
	constants "github.com/harrycodawang/rocketmq-operator/pkg/constants"
	controllerutils "github.com/harrycodawang/rocketmq-operator/pkg/controllers/util"
	clientset "github.com/harrycodawang/rocketmq-operator/pkg/generated/clientset/versioned"
	opscheme "github.com/harrycodawang/rocketmq-operator/pkg/generated/clientset/versioned/scheme"
	informersv1alpha1 "github.com/harrycodawang/rocketmq-operator/pkg/generated/informers/externalversions/rocketmq/v1alpha1"
	listersv1alpha1 "github.com/harrycodawang/rocketmq-operator/pkg/generated/listers/rocketmq/v1alpha1"

	operatoropts "github.com/harrycodawang/rocketmq-operator/pkg/options"
	services "github.com/harrycodawang/rocketmq-operator/pkg/resources/services"
	statefulsets "github.com/harrycodawang/rocketmq-operator/pkg/resources/statefulsets"
)
...
func (m *BrokerController) syncHandler(key string) error {
	...
	for index := 0; index < groupReplica; index++ {
		...
		if apierrors.IsNotFound(err) {
			...
			ss = statefulsets.NewStatefulSet(cluster, index, cluster.Spec.StorageClass)
